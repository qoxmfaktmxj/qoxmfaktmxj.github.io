...
### 4. `star-repo-deep-dive.yml`

GitHub star 50,000+ 공개 저장소를 분석해 `GitHub Repo Analysis` 글을 생성하는 워크플로입니다.

- 매일 22:10 UTC에 실행됩니다.
- 실제 발행 주기는 `scripts/star_repo_deep_dive.py`와 `.automation/star_repo_analysis.json`의 48시간 guard가 제어합니다.
- 수동 실행도 가능합니다.
